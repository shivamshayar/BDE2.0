export const translations = {
  en: {
    ...
    tracker: {
      ...
      scannerMode: 'Scanner',
      addEntry: 'Add',
      addEntryTitle: 'Add Work Entry',
      addEntryDescription: 'Manually enter a completed work time',
      day: 'Day',
      ...
      invalidPerformanceId: 'Invalid Performance ID. Please choose one from the list.',
  ...
  de: {
    ...
    tracker: {
      ...
      scannerMode: 'Scanner',
      addEntry: 'Hinzufügen',
      addEntryTitle: 'Arbeitszeit hinzufügen',
      addEntryDescription: 'Abgeschlossene Arbeitszeit manuell erfassen',
      day: 'Tag',
      startTime: 'Startzeit',
      ...
      invalidPerformanceId: 'Ungültige Leistungs-ID. Bitte wählen Sie eine aus der Liste.',
